...
const Register = () => {
    ...
    // get the redirect parameter and check if it is checkout or something else
    ...
    }, [user, guestId, cart, cart, navigate, isCheckoutRedirect, dispatch])
            ...
            <div className='w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-12'>
                <form onSubmit={handleSumbit} className='w-full max-w-md bg-white p-8 rounded-lg border shadow-sm'>
                    <div className='flex justify-center mb-6'>
                        <h2 className='text-xl font-medium'>Shopaholic</h2>
                    </div>
