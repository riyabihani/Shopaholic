...
// async thunk to add the create user actions
...
export const updateUser = createAsyncThunk("admin/updateUser", async ({ id, naem, email, role }) => {
...
// async thunk to delete the user
