...
const FilterSidebar = () => {
  ...
  const brands = ['Urban Trends', 'Modern Fit', 'Street Style', 'Beach Breeze', 'Fashionista', 'ChicStyle', 'H&M'];
  ...
  const updateURLParams = (newFilters) => {
    ...
    navigate(`?${params.toString()}`) // ?category=Bottom+Wear&size=XS%2CS -> %2C is the encoded version of ,
  };
        ...
        {genders.map((gender) => (
          <div key={gender} className='flex items-center mb-1'>
            <input 
              ...
              value={gender} onChange={handleFilterChange}
        ...
        {brands.map((brand) => (
          <div key={brand} className='flex items-center mb-1'>
            <input 
              ...
              value={brand} onChange={handleFilterChange}
