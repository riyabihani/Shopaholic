  ...
  return (
    <footer className='border-t py-12'>
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
            ...
            {/* Subscription Form */}
            <div>
                <h3 className='text-lg text-gray-800 mb-6'>Newsletter</h3>
                ...
                <form className='flex'>
                    <input type="email" placeholder='Enter your email' className='p-3 w-full text-sm border-t border-l border-b border-gray-300 rounded-l-md focus:outline-non focus:ring-2 focus:ring-gray-500 transition-all' />
